...
{
    public sealed partial class StarRarting : UserControl
    {
        public static readonly DependencyProperty RateProperty =
            DependencyProperty.Register("Rate", typeof(double), typeof(StarRarting), new PropertyMetadata(0.0, new PropertyChangedCallback(OnRateChanged)));
        ...
        {
            var uc = obj as StarRarting;
            if (uc != null && e.NewValue != e.OldValue)
            {
                double value = Convert.ToDouble(e.NewValue) / 2;
